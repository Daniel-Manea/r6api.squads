...
const requestUbiToken = async () => {
    const AxiosConfig = {
        "Authorization": `${config_json_1.Ubi_HEADERS.Authorization}`,
    ...
    const AuthToken = await axios_1.default.post(`${config_json_1.Ubi_URLS.Public}/v3/profiles/sessions`, { "rememberMe": false }, {
        headers: AxiosConfig
    });
